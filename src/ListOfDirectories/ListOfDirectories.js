...
export default function ListOfDirectories () {
    const { removeDirectory, setKeySelected, directoriesList, countList } = useContext(Context);
                ...
                <li className="directory-select" key={index} >
                    <div className="task-style" >
                        <Link className='link-style' to={`/directory/${directory.id}`}>
                            <div className="label-content" onClick={() => {setKeySelected(directory.id);}}>
